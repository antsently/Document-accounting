Public Class Form12
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Me.Text = "Добавление записи" Then
            If TextBox1.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Or TextBox5.Text = "" Or TextBox6.Text = "" Or TextBox7.Text = "" Then
                ...
                OtchetGurnal = "Не все строки заполнили Приказ по АХД" & DateString & " " & TimeString : ZapGurnal()
            Else
                p1 = TextBox1.Text
                ...
                Me.Close()
                OtchetGurnal = "Добавление записи Приказ по АХД " & DateString & " " & TimeString : ZapGurnal()
            End If
        Else
            p1 = TextBox1.Text
            p2 = DateTimePicker1.Value
            ...
            Form11.Editor_zap()
            Me.Close()
            OtchetGurnal = "Редактирование записи книги Приказ по АХД " & DateString & " " & TimeString : ZapGurnal()
        End If
    End Sub

    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        OtchetGurnal = "Отмена операции с Приказ по АХД" & DateString & " " & TimeString : ZapGurnal()
        Close()
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            If МВох = DialogResult.Yes Then
                ...
                OtchetGurnal = "Вмешательства в ключевые поля Приказ по АХД" & DateString & " " & TimeString : ZapGurnal()
            End If
    ...
    Private Sub Form12_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        If Me.Text = "Добавление записи" Then
            ...
            OtchetGurnal = "Загрузка добавления записи Приказ по АХД" & DateString & " " & TimeString : ZapGurnal()
        Else
            TextBox1.Text = p1
            ...
            TextBox6.Text = p6
            TextBox7.Text = p7
            OtchetGurnal = "Загрузка редактирование записи Приказ по АХД" & DateString & " " & TimeString : ZapGurnal()
        End If
    End Sub
End Class