...
Partial Class Form3
    ...
    Private Sub InitializeComponent()
        ...
        Me.ToolStripComboBox1.Items.AddRange(New Object() {"Дата поступления", "Регистрационный номер", "Корреспондент документа ", "Исходящий номер и дата докумнета", "Заголовок (краткое содержание докумнета)", "Количество листов с приложением", "Резолюция или кому направлен документ", "Исполнитель", "Срок исполнения", "Отметка о постановке на контроль", "Отметка об исполнении", "Примечание"})
