...
Partial Class Form9
    ...
    Private Sub InitializeComponent()
        ...
        Me.MenuStrip1.Size = New System.Drawing.Size(281, 24)
        ...
        Me.МенюИсходящихToolStripMenuItem.Size = New System.Drawing.Size(181, 20)
        ...
        Me.ToolStripComboBox1.Items.AddRange(New Object() {"Регистрационный номер", "Дата регистрации", "Краткое содержание", "Количство листов", "Исполнитель", "Куда передан приказ", "Отметка о помещении в дело"})
