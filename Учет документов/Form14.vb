Public Class Form14
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            If МВох = DialogResult.Yes Then
                ...
                OtchetGurnal = "Вмешательства в ключевые поля Докладные и служебные записки " & DateString & " " & TimeString : ZapGurnal()
            End If
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        OtchetGurnal = "Отмена операции с Докладные и служебные записки " & DateString & " " & TimeString : ZapGurnal()
        Close()
    End Sub
    ...
    Private Sub Form14_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Else
            ...
            TextBox6.Text = p6
            TextBox7.Text = p7
            OtchetGurnal = "Загрузка редактирование данных Докладные и служебные записки " & DateString & " " & TimeString : ZapGurnal()
        End If
    End Sub
End Class