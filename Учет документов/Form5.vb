...
Public Class Form5
    ...
    Private Sub Form5_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Try
            ...
            Else
                Poisk = "SELECT * FROM Договоры where ((Договоры.[" & ToolStripComboBox1.Text & "]) Like '%" & ToolStripTextBox1.Text & "%')"
            End If
    ...
    Private Sub ListView1_MouseUp(sender As Object, e As MouseEventArgs) Handles ListView1.MouseUp
        ...
        If e.Button = MouseButtons.Right Then
            ItemIndex = ListView1.SelectedItems.Count
            If ItemIndex = 1 Then
    ...
    Private Sub ToolStripButton2_Click(sender As Object, e As EventArgs) Handles ToolStripButton2.Click
        ОбновитьToolStripMenuItem1_Click(Me, New EventArgs)
    End Sub
